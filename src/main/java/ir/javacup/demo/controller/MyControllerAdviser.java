...
import ir.javacup.demo.domain.api.ErrorResponseDto;
import ir.javacup.demo.domain.api.ValidationErrorDto;
...
@Slf4j
public class MyControllerAdviser extends ResponseEntityExceptionHandler {
